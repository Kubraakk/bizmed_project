...
from .views import HomeView,PatientCreateView, RegistrationCreateView, TCKNSearchView,DefinitionView
...
urlpatterns = [
    ...
    path("definitions/", DefinitionView.as_view(), name="definitions"),
